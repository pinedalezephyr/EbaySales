...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private int mConditionName = InventoryEntry.UNKNOWN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProductNameEditText = findViewById(R.id.item_name_edit_text);
        ...
        mConditionspinner = findViewById(R.id.item_condition_spinner);
    ...
    private void setupSpinner() {
        ...
        mConditionspinner.setAdapter(productSupplieNameSpinnerAdapter);
        ...
        mConditionspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.unknown))) {
                        mConditionName = InventoryEntry.UNKNOWN;
                    } else if (selection.equals(getString(R.string.new_item))) {
                        mConditionName = InventoryEntry.NEW;
                    } else if (selection.equals(getString(R.string.used_item))) {
                        mConditionName = InventoryEntry.USED;
                    } else {
                        mConditionName = InventoryEntry.NEW_OPENED;
                    }
                }
            }
    ...
    private void saveProduct() {
        ...
        if (mCurrentProductUri == null) {
            ...
            if (mConditionName == InventoryEntry.UNKNOWN) {
                Toast.makeText(this, getString(R.string.item_name_requires), Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            values.put(InventoryEntry.COLUMN_PRODUCT_CONDITION, mConditionName);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int supplierNameColumnIndex = cursor.getColumnIndex(InventoryEntry.COLUMN_PRODUCT_CONDITION);
            ...
            switch (currentSupplierName) {
                case InventoryEntry.NEW:
                    mConditionspinner.setSelection(1);
                    break;
                case InventoryEntry.USED:
                    mConditionspinner.setSelection(2);
                    break;
                case InventoryEntry.NEW_OPENED:
                    mConditionspinner.setSelection(3);
                    break;
                default:
