...
public class ViewActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConditionSpinner = findViewById(R.id.item_name_view_text);
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.NEW_OPENED:
                    mConditionSpinner.setText(getText(R.string.new_opened));
                    break;
                case InventoryEntry.NEW:
                    mConditionSpinner.setText(getText(R.string.new_item));
                    break;
                case InventoryEntry.USED:
                    mConditionSpinner.setText(getText(R.string.used_item));
                    break;
                default:
                    mConditionSpinner.setText(getText(R.string.unknown));
                    break;
            }
